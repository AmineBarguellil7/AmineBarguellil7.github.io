  ...
  return (
    <header className={cn("sticky top-0 z-40 border-b border-transparent transition-all duration-300", scrolled && "border-white/10 bg-[#10110e]/90 backdrop-blur-md")}>
      <div className="section-shell flex h-16 items-center justify-between">
        <button type="button" onClick={backToTop} className="flex cursor-pointer items-center gap-3" aria-label="Back to top">
        ...
        <a href="#contact" className="hidden items-center gap-2 text-xs font-bold uppercase tracking-wider sm:flex">LET&apos;S TALK <ArrowUpRight className="size-4 text-primary" /></a>
