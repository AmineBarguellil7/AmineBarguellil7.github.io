...
export function ProjectsSection({ projects }: { projects: readonly Project[] }) {
  return (
    <section id="projects" className="section-shell section-space">
      <Reveal><SectionHeading eyebrow="Selected work" title="Projects with a reason to exist." description="Full-stack systems, product interfaces, and AI experiments—selected for the decisions behind them, not the buzzwords around them." /></Reveal>
